        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-5xl font-extrabold mb-6 anim">
              Đối tác <em className="not-italic text-[#4a90e2]">tin cậy</em>
              <br />
              trong công nghiệp laser
            </h2>
            <p className="text-lg text-[rgba(255,255,255,0.6)] mb-6 leading-relaxed anim">
              <strong className="text-white">Yihuixuan (Nghệ Huy Hiên)</strong> là đại diện chính thức của <strong className="text-white">Suzhou Borna Laser Technology</strong> tại Việt Nam, thành lập năm 2022 tại Bắc Ninh.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
              <div className="text-center anim">
                ...
                <div className="text-sm text-[rgba(255,255,255,0.6)]">Dự án hoàn thành</div>
              </div>
              <div className="text-center anim">
                <div className="text-4xl font-extrabold text-[#4a90e2] mb-2">98%</div>
                <div className="text-sm text-[rgba(255,255,255,0.6)]">Khách hài lòng</div>
              </div>
              <div className="text-center anim">
                <div className="text-4xl font-extrabold text-[#4a90e2] mb-2">24/7</div>
                <div className="text-sm text-[rgba(255,255,255,0.6)]">Hỗ trợ kỹ thuật</div>
              </div>
            </div>
